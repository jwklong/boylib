...
inline void tokenize(const BoyLib::UString& str, const BoyLib::UString &delimitersNotReturned, const BoyLib::UString &delimitersReturned, std::vector<BoyLib::UString> &tokens)
{
	...
	BoyLib::UString delim(delimitersNotReturned);
...
inline void tokenize(const BoyLib::UString& str, const BoyLib::UString& delimiters, std::vector<BoyLib::UString> &tokens)
{
	return tokenize(str,delimiters,BoyLib::UString(),tokens);
}
...
inline BoyLib::UString trim(const BoyLib::UString& theString)
{
